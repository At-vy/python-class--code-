...
mydictionary = {"name": "atharva", "age": 18, "city": "indore"}
print(mydictionary)
# operations on dictionary
print(mydictionary["name"]) # access value by key = atharva
mydictionary["age"] = 19 # modify value by key
print(mydictionary)
mydictionary["country"] = "India" # add new key-value pair4
